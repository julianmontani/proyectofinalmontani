...
urlpatterns = [
    ...
    path('amplificadorDetalle/<int:pk>/',
         AmplificadorDetalle.as_view(), name='amplificador'),
    ...
    path('guitarraEdicion/<int:pk>/',
         GuitarraUpdate.as_view(), name='guitarra_editar'),
    ...
    path('amplificadorEdicion/<int:pk>/',
         AmplificadorUpdate.as_view(), name='amplificador_editar'),
    path('tecladoEdicion/<int:pk>/',
         TecladoUpdate.as_view(), name='teclado_editar'),
    path('bateriaEdicion/<int:pk>/',
         BateriaUpdate.as_view(), name='bateria_editar'),
    path('otroEdicion/<int:pk>/', OtroUpdate.as_view(), name='otro_editar'),


    path('guitarraBorrado/<int:pk>/',
         GuitarraDelete.as_view(), name='guitarra_eliminar'),
    ...
    path('amplificadorBorrado/<int:pk>/',
         AmplificadorDelete.as_view(), name='amplificador_eliminar'),
    path('tecladoBorrado/<int:pk>/',
         TecladoDelete.as_view(), name='teclado_eliminar'),
    path('bateriaBorrado/<int:pk>/',
         BateriaDelete.as_view(), name='bateria_eliminar'),
    ...
    path('instrumentoBusqueda/', InstrumentoBusqueda.as_view(),
         name='busqueda_instrumento'),


    path('guitarraDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
    path('bajoDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
    path('pedalDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
    path('amplificadorDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
    path('bateriaDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
    path('tecladoDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
    path('otroDetalle/<int:pk>/comentario/',
         ComentarioPagina.as_view(), name='comentario'),
